...
insert into employee1 values(100,'Jon','Hamm',10,2000.00),
    ...
    USE assignment;
    DROP TABLE students;
    CREATE TABLE if not exists students  (id  int(11) NOT NULL PRIMARY KEY, name varchar(25) DEFAULT NULL, marks float(6,2) DEFAULT NULL);
desc students;
INSERT INTO  students  VALUES (11,'Britney',95.00),
  ...
  CREATE TABLE station (id int(11) DEFAULT NULL,city varchar(21) DEFAULT NULL,state char(4) DEFAULT NULL,lat_n float(7,2) DEFAULT NULL,long_w float(7,2) DEFAULT NULL);
  ...
  INSERT INTO station VALUES (794,'Kissee Mills','MO',139.65,73.42),
                             ...
                             (65,'Buffalo','CO',47.66,148.19),
                             (753,'Algonac','MI',118.74,80.15),
                             ...
                             (854,'Kirkland','AZ',86.41,58.00),
                             (160,'Grosse','MI',102.05,91.37),
                             (735,'Wilton','ME',56.58,157.19),
                             (608,'Busby','MT',104.09,29.83),
                             (122,'Robertsdale','AL',97.72,85.37),
                             (93,'Dale','IN',69.59,34.42),
                             (67,'Reeds','MO',30.79,42.50),
                             (906,'Hayfork','CA',35.30,116.67),
                             (34,'Mcbrides','MI',74.06,35.68),
                             (921,'Lee Center','IL',95.79,77.13),
                             (401,'Tennessee','IL',55.50,155.65),
                             (536,'Henderson','IA',77.92,77.91),
                             (953,'Udall','KS',112.68,59.96),
                             (370,'Palm Desert','CA',106.81,145.76),
                             (614,'Benedict','KS',138.50,95.72),
                             (998,'Oakfield','ME',47.66,132.21),
                             (805,'Tamms','IL',59.87,75.05),
                             (235,'Haubstadt','IN',27.99,32.08),
                             (820,'Chokio','MN',81.36,134.23),
                             (650,'Clancy','MT',45.83,164.38),
                             (791,'Scotts','CA',119.93,90.95),
                             (324,'Norwood','MN',144.49,34.89),
                             (442,'Elkton','MD',103.25,156.73),
                             (633,'Bertha','MN',39.95,105.31),
                             (109,'Bridgeport','MI',50.69,79.90),
                             (780,'Cherry','IL',68.30,46.70),
                             (492,'Regina','KY',131.55,90.24),
                             ...
                             (752,'East','CA',106.23,115.25),
                             (886,'Pony','MT',99.26,162.88),
                             (200,'Franklin','LA',82.24,31.78),
                             (384,'Amo','IN',103.59,159.43),
                             (518,'Vulcan','MO',108.61,91.56),
                             (188,'Prairie Du Rocher','IL',75.58,70.71),
                             (161,'Alanson','MI',90.65,72.12),
                             (486,'Delta','LA',136.54,49.73),
                             (406,'Carver','MN',45.89,122.07),
                             (940,'Paron','AR',59.14,104.34),
                             (237,'Winchester','ID',38.37,80.05),
                             (465,'Jerome','AZ',121.71,34.41),
                             (591,'Baton','LA',129.84,71.75),
                             (570,'Greenview','CA',80.50,57.59),
                             ...
                             (668,'Rockton','IL',116.12,86.84),
                             (682,'Pheba','MS',90.95,127.30),
                             (775,'Eleele','HI',80.91,152.52),
                             (527,'Auburn','IA',95.49,137.07),
                             (108,'North','ME',70.83,27.32),
                             (190,'Oconee','GA',92.56,119.48),
                             (232,'Grandville','MI',38.85,70.14),
                             (405,'Susanville','CA',128.25,80.32),
                             (273,'Rosie','AR',72.76,161.92),
                             (813,'Verona','MO',109.66,152.64),
                             ...
                             (377,'Koleen','IN',137.55,110.51),
                             (727,'Winslow','IL',113.13,38.71),
                             (363,'Reasnor','IA',41.60,162.56),
                             (117,'West','IA',127.23,99.41),
                             (420,'Frankfort','IL',71.60,30.37),
                             (888,'Bono','AR',133.28,150.50),
                             (784,'Biggsville','IL',85.93,138.75),
                             (413,'Linthicum','MD',127.56,67.73),
                             (695,'Amazonia','MO',45.79,148.20),
                             (609,'Marysville','MI',85.76,132.87),
                             (471,'Cape','MO',73.50,90.54),
                             (649,'Pengilly','MN',25.07,154.06),
                             (946,'Newton','MA',48.41,144.84),
                             (380,'Crane','MN',72.92,43.22),
                             (383,'Newbury','MA',128.40,85.17),
                             (44,'Kismet','KS',99.82,156.50),
                             (433,'Canton','ME',98.73,105.97),
                             (283,'Clipper','CA',113.72,56.95),
                             (474,'Grayslake','IL',61.30,33.06),
                             (233,'Pierre','LA',52.09,90.06),
                             (990,'Bison','KS',132.23,74.89),
                             (502,'Bellevue','KY',127.43,121.75),
                             (327,'Ridgway','CO',77.44,110.27),
                             (4,'South','CT',65.58,33.61),
                             (228,'Rydal','GA',35.68,78.82),
                             (642,'Lynnville','KY',25.41,146.49),
                             (885,'Deerfield','MO',40.21,35.94),
                             (539,'Montreal','MO',129.25,127.33),
                             (202,'Hope','MN',140.36,43.73),
                             (593,'Aliso','CA',67.52,131.42),
                             (521,'Gowrie','IA',130.20,127.98),
                             (938,'Andersonville','GA',141.31,72.53),
                             (919,'Knob','KY',135.85,33.39),
                             (528,'Crouseville','ME',36.52,81.54),
                             (331,'Cranks','KY',55.61,27.28),
                             (45,'Rives','MI',94.20,116.85),
                             (944,'Ledyard','CT',134.55,143.81),
                             (949,'Norway','ME',83.89,88.41),
                             (88,'Eros','LA',95.16,58.31),
                             (878,'Rantoul','KS',31.80,118.62),
